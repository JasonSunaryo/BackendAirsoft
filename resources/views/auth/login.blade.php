        ...
        <div class="col-md-8">
            <div class="card shadow-lg border-0" style="background-color: #324a73;">
                <div class="card-header text-white text-center" style="background-color: #4d5e71;">
                    ...
                    <h4 class="mb-0 mt-2">{{ __('Login') }}</h4>
                </div>
                <div class="card-body p-5">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus style="background-color: #475d92; color: white;">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" style="background-color: #475d92; color: white;">
